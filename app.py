    ...
    if query:
        ...
        with st.spinner("Run two RAG methods..."):
            ...
            with col1:
                ...
                ]  # Construct the message format to send to LLM
                vector_response = llm.chat.completions.create(
                    model="gpt-3.5-turbo",
                    messages=vector_messages
                )  # Calling the OpenAI API generates a response
                vector_answer = vector_response.choices[0].message.content  # Extract the answer text generated by LLM
